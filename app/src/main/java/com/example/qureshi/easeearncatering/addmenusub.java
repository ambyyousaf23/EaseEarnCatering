...
public class addmenusub extends Fragment {

    Button add;
    EditText items, addPrice;
    ImageView image;
    Intent intent;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_addmenu, container, false);

        getPreference();

        intent=getActivity().getIntent();

        Toast.makeText(mActivity, SharedClass.cater_id, Toast.LENGTH_SHORT).show();
        ...
        addPrice=rootView.findViewById(R.id.addPrice);
    ...
    private void uploadImage(final String name){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://easeearn.000webhostapp.com/addSubMenu.php",
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("menuID", SharedClass.cater_id);
                params.put("price", addPrice.getText().toString());
