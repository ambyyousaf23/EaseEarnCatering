...
public class InvoiceCustomAdapter extends BaseAdapter {

    Context context;
    List<OrderDataModel> invoice;

    public InvoiceCustomAdapter(Context context, List<OrderDataModel> invoice) {
